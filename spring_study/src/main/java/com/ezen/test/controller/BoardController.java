...
public class BoardController {
	...
	//@RequsetParam("name")String name : 파라미터를 받을 때
	...
	@GetMapping("/list")
	public String list(Model m, PagingVO pgvo) { //PagingVO 파라미터가 없으면 기본 생성자 값이 든다.
		log.info(">> pgvo >> {}",pgvo);
