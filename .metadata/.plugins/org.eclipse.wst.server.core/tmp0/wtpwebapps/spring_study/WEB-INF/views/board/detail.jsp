	...
	<h1>Board Detail Page</h1>
		<c:set value="${bdto.bvo}" var="bvo"></c:set>
			...
			<div class="mb-3">
		  		...
		  		<input type="text" class="form-control" name="title" id="t" value="${bvo.title }" readonly="readonly" placeholder="titl..">
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
			  ...
			  <textarea class="form-control" id="c" name="content" readonly="readonly" aria-label="With textarea">${bvo.content }</textarea>
			</div>
			<!-- file upload 표시라인 -->
